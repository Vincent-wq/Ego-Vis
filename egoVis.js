...
var c0 = "black"
var c25i= d3.scale.quantize().domain([2.1,4.1,8.1,10]).range(["#fdd0a2","#fdae6b","#fd8d3c","#f16913","#d94801"])
var c25o= d3.scale.quantize().domain([2.1,4.1,8.1,10]).range(["#dadaeb","#bcbddc","#9e9ac8","#807dba","#6a51a3"])
...
var chord_Color3 = d3.scale.quantize()
                          .domain([0,1,2,3])
                          .range(["#fc8d62","#8da0cb","#a6d854","#bf812d"])
...
// bubleVis
var width_buble = 1920; var height_buble = 720;
...
// chordVisl
        ...
        //console.log(chord_stellar.groups())
...
// Alter nodes initialize
        ...
        var svgTrend = svgStellar.append("rect")
                                 .attr("x",30)
                                 .attr("y",500)
                                 .attr("width",260)
                                 .attr("height",200)
...
// force circle
  var circles = svgBuble.selectAll("circle")
           ...
           .attr({"r" : function (d) { return d.rr; },
              ...
              "stroke-width" : 2 ,
              "class" : "circles" })
           .attr("stroke", function (d ) {return scatterNum(d.att2);})
           .attr("fill", function (d ) {return d3.rgb(scatterNum(d.att2)).brighter();})
...
console.log(height_buble - padding_buble.bottom);
